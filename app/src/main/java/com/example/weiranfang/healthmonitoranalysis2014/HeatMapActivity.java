...
public class HeatMapActivity extends BaseDemoActivity {
    ...
    protected void startDemo() {
        ...
        try {
            ...
            mLists.put(getString(R.string.tweet_heat_map), new DataSet(readItems(jsonArray),
        ...
        public void onItemSelected(AdapterView<?> parent, View view,
            ...
            if (mProvider == null) {
                mProvider = new HeatmapTileProvider.Builder().data(
                        mLists.get(getString(R.string.tweet_heat_map)).getData()).build();
    ...
    private ArrayList<LatLng> readItems(JSONArray jsonArray) throws JSONException {
        ArrayList<LatLng> list = new ArrayList<LatLng>();
        //InputStream inputStream = getResources().openRawResource(resource);
        //String json = new Scanner(inputStream).useDelimiter("\\A").next();
        //JSONArray array = new JSONArray(json);
    ...
    private class GenerateJSONArrayTask extends AsyncTask<JSONSender,Long,JSONArray> {
        ...
        protected JSONArray doInBackground(JSONSender... params) {
            ...
            return params[0].GetArrayByID(3);
        }
    }
