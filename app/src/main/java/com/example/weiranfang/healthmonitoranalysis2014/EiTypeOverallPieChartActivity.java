...
public class EiTypeOverallPieChartActivity extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
            inflater.inflate(R.menu.menu_pie_chart, menu);
        }
        ...
        private void generateData(JSONArray jsonArray) throws JSONException {
            ...
            for (int i = 0; i < numValues; ++i) {
                ...
                arcValue.setLabel(jsonObject.getString("exercise_type").toCharArray());
