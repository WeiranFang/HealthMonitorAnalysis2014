...
public class HealthFoodViewPagerChartsActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            int sectionNum = getArguments().getInt(ARG_SECTION_NUMBER);
                    ...
                    PieChartView typePieChartView = new PieChartView(getActivity());

                    try {
                        PieChartData typePieChartData = generatePieChartData(sectionNum,
                                new GenerateJSONArrayTask().execute(new JSONSender()).get());

                        typePieChartView.setPieChartData(typePieChartData);
                    ...
                    typePieChartView.setContainerScrollEnabled(true, ContainerScrollType.HORIZONTAL);
                    typePieChartView.setOnValueTouchListener(new ValueTouchListener());

                    layout.addView(typePieChartView);
        ...
        private PieChartData generatePieChartData(int typeIndex, JSONArray jsonArray) throws JSONException {
            List<ArcValue> values = new ArrayList<ArcValue>();

            for (int i = typeIndex; i < jsonArray.length(); i = i + 7) {
                JSONObject jsonObject = jsonArray.getJSONObject(i);
                int pieceData = jsonObject.getInt("exercise_count");
                char[] pieceLabel = jsonObject.getString("food_type").toCharArray();
        ...
        private class GenerateJSONArrayTask extends AsyncTask<JSONSender,Long,JSONArray> {
            ...
            protected JSONArray doInBackground(JSONSender... params) {
                ...
                return params[0].GetArrayByID(19);
            }
        }
    }
