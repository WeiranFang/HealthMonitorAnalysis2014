...
public class ETimeTypeViewPagerChartsActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public final static String[] types = new String[] { "Running", "Cycling", "Swimming",
...
*/
        ...
        private class GenerateJSONArrayTask extends AsyncTask<JSONSender,Long,JSONArray> {
            ...
            protected JSONArray doInBackground(JSONSender... params) {
                ...
                return params[0].GetArrayByID(12);
            }
        }
